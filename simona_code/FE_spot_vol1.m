function spot = FE_spot_vol1(P,t,tau,T,N,M)
...
fft_v=fft(r); % using FFT
idx=2:N+M+1; ff=fft_v(idx);
fft_def=[conj(ff(end:-1:1)); c_0; ff];
c_p=fft_def./T; % Fourier coeff. of log-returns
